...
app.controller('homeController', ['$scope', '$ionicModal', 'leafletEvents', '$ionicLoading', 'alertData', 'Utilities', 'Alerts', function($scope, $ionicModal, leafletEvents, $ionicLoading, alertData, Utilities, Alerts){
...
app.controller('mapController', ['$scope', 'Geo', '$ionicLoading', 'alertData', function($scope, Geo, $ionicLoading, alertData) {
